...
namespace nguyenanhung\ShortenUrl\Driver;
...
class Bitly
{
     ...
     * @throws \nguyenanhung\ShortenUrl\Driver\BitlyError
     */
    ...
    public function search(
        $query, $limit = 10, $offset = 0, $lang = NULL,
    ...
    public function userLinkHistory(
        $link = NULL, $limit = 50, $offset = NULL,
    ...
    public function userNetworkHistory(
        $offset = NULL, $expandClientId = FALSE,
    ...
    public function bundleEdit(
        $bundleLink, $title = NULL, $description = NULL,
